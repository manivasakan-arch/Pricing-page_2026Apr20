  ...
  return (
    <div className="mx-auto w-full max-w-[954px]">
      <div className="relative h-[620px] w-full">
        {/* Pro (highlighted) */}
        <div
          className="absolute left-0 top-0 z-20 h-[620px] w-[318px] overflow-visible rounded-[24px] border-2 border-brand-border shadow-[0px_1px_2px_0px_rgba(0,0,0,0.08),0px_4px_10px_0px_rgba(0,0,0,0.06)]"
          style={{
            backgroundImage: "linear-gradient(127.06deg, #ffffff 2.19%, #ffffff 41.38%, #ffeee5 98.14%)",
          }}
        >
          <div className="absolute left-[22px] top-[65px] h-[44px] w-[44px]">
          ...
          <div className="absolute left-[22px] top-[192px] w-[270px]">
            <UserSelect value={proSeats} onChange={setProSeats} />
          </div>
          <button
            type="button"
            className="group absolute left-[22px] top-[238px] h-[48px] w-[270px] overflow-hidden rounded-[4px] transition hover:shadow-[0_6px_14px_-4px_rgba(255,85,0,0.45)]"
          ...
          <div className="absolute left-[22px] top-[296px] flex w-[270px] items-center justify-center gap-2">
        ...
        <div className="absolute left-[318px] top-[21px] z-10 h-[597px] w-[318px] rounded-r-[24px] border border-line-primary bg-white">
          ...
          <div className="absolute left-[24px] top-[172px] w-[270px]">
            <UserSelect value={goldSeats} onChange={setGoldSeats} showDiscount={false} />
          </div>
          <button
            type="button"
            className="absolute left-[24px] top-[218px] flex h-[48px] w-[270px] items-center justify-center rounded-[4px] border border-brand transition hover:bg-brand-50 active:bg-brand-100"
          >
            <p className="text-[16px] font-bold leading-[16px] text-brand">Buy Now</p>
          </button>
          <div className="absolute left-[24px] top-[276px] flex w-[270px] items-center justify-center gap-2">
            <CheckCircle size={14} weight="fill" className="shrink-0 text-success" />
            <p className="text-[12px] leading-[1.33] text-success">{"You'll save ₹XX,XXX this year"}</p>
          </div>
          <div className="absolute left-1/2 top-[312px] flex w-[270px] -translate-x-1/2 flex-col gap-4 items-start">
        ...
        {/* Enterprise */}
        <div className="absolute left-[612px] top-[21px] h-[540px] w-[342px] rounded-r-[24px] border border-line-primary bg-white">
          ...
          <p className="absolute left-[48px] top-[100px] text-[24px] font-bold leading-none text-ink-primary">Enterprise</p>

          <div className="absolute left-[48px] top-[149px] flex w-[270px] flex-col items-center gap-[8px]">
          ...
          <button
            type="button"
            className="absolute left-[48px] top-[220px] flex h-[48px] w-[270px] items-center justify-center rounded-[4px] border border-brand transition hover:bg-brand-50 active:bg-brand-100"
          >
